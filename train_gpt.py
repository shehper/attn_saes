...
total_training_steps = 250_000 # this is ~10 times more than Kissane et al.
batch_size = 4096 
...
l1_coefficients = [5] # could be more than one values, e.g. [2, 5, 10]
d_in= 768
expansion_factor = 64 if hook_layer in [5, 7] else 32 # following Kissane et al 2406.17759, Appendix B
